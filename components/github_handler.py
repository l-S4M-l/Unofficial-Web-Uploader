...
class GithubHandler:
    ...
    def login_with_github(self,scope='repo,delete_repo'):

        Q = mp.Queue()
        p = mp.Process(target=run_oauth_server, args=(Q,))
        p.start()

        # Open browser to GitHub login
        params = {
    ...
    def write_logo_psg(self, psg_path):
        pass
